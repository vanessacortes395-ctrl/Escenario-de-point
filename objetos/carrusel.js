...
export default function E01({x,y,z}){
    ...
    const cabeza1 = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.5, 0.5), new THREE.MeshLambertMaterial({ color: 0x8B4513 })); // Marrón (Madera)
    ...
    const cabeza2 = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.5, 0.5), new THREE.MeshLambertMaterial({ color: 0x8B4513 })); // Marrón (Madera)
